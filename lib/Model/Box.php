...
class Box implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'type' => 'string',
        'items' => '\OpenAPI\AllegroSdk\Model\ProductItem[]'
    ];
     ...
     * Sets id
     *
     * @param string|null $id An identifier of the box
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\AllegroSdk\Model\ProductItem[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\AllegroSdk\Model\ProductItem[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling Box., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling Box., number of items must be greater than or equal to 1.');
        }
