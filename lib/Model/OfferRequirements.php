...
/**
 * OfferRequirements Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferRequirements';
     ...
     * Sets id
     *
     * @param string|null $id The id of the offer that can be associated with this product.
     *
     * @return self
     */
     ...
     * Sets parameters
     *
     * @param \OpenAPI\AllegroSdk\Model\ProductParameterDto[]|null $parameters parameters
     *
     * @return self
     */
