 ...
 */
class CheckoutFormSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutFormSummary';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_to_pay'] === null) {
            $invalidProperties[] = "'total_to_pay' can't be null";
        }
     ...
     * Sets total_to_pay
     *
     * @param Price $total_to_pay total_to_pay
     *
     * @return self
     */
