 ...
 */
class CheckoutFormDeliveryTimeGuaranteed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutFormDeliveryTimeGuaranteed';
