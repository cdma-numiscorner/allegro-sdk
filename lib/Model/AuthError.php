 ...
 */
class AuthError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthError';
     ...
     * Sets error
     *
     * @param string $error Authorization error code
     *
     * @return self
     */
     ...
     *
     * @param string|null $error_description Authorization error message
     *
     * @return self
     */
