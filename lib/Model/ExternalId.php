 ...
 */
class ExternalId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalId';
     ...
     * Sets id
     *
     * @param string|null $id The ID of the offer in the external system.
     *
     * @return self
     */
    public function setId($id)
    {
        if (!is_null($id) && (mb_strlen($id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ExternalId., must be smaller than or equal to 100.');
        }
