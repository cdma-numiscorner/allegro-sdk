...
class ParametersForPreviewPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'category' => '\OpenAPI\AllegroSdk\Model\Category',
        'condition' => 'string',
        'duration' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_any_quantity'] = $data['has_any_quantity'] ?? null;
        $this->container['number_of_big_photos'] = $data['number_of_big_photos'] ?? null;
        $this->container['number_of_photos'] = $data['number_of_photos'] ?? null;
        ...
        $this->container['emphasized_highlight_bold_package'] = $data['emphasized_highlight_bold_package'] ?? null;
        $this->container['multi_variant'] = $data['multi_variant'] ?? null;
    }
     ...
     * Gets category
     *
     * @return \OpenAPI\AllegroSdk\Model\Category
     */
     ...
     * Sets category
     *
     * @param \OpenAPI\AllegroSdk\Model\Category $category category
     *
     * @return self
     */
    ...
    public function setNumberOfBigPhotos($number_of_big_photos)
    {
        ...
        if (!is_null($number_of_big_photos) && ($number_of_big_photos < 0)) {
    ...
    public function setNumberOfPhotos($number_of_photos)
    {
        ...
        if (!is_null($number_of_photos) && ($number_of_photos < 0)) {
    ...
    public function setSoldQuantity($sold_quantity)
    {
        ...
        if (!is_null($sold_quantity) && ($sold_quantity < 0)) {
