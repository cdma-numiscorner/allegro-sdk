 ...
 */
class BillingEntryTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingEntry_tax';
     ...
     * Sets percentage
     *
     * @param string|null $percentage Optional tax rate shown as a number in the range 0-100.
     *
     * @return self
     */
     ...
     * Sets annotation
     *
     * @param string|null $annotation Optional annotation explaining the tax rate.
     *
     * @return self
     */
