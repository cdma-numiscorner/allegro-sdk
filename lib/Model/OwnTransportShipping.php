...
class OwnTransportShipping extends Shipping 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OwnTransportShipping';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['truck_licence_plate'] === null) {
            $invalidProperties[] = "'truck_licence_plate' can't be null";
        }
        if ($this->container['estimated_time_of_arrival'] === null) {
            $invalidProperties[] = "'estimated_time_of_arrival' can't be null";
        }
