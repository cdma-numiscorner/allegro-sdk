...
class StockQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['on_offer'] = $data['on_offer'] ?? null;
        $this->container['on_order'] = $data['on_order'] ?? null;
     ...
     * Sets on_offer
     *
     * @param float|null $on_offer A number of items in a warehouse available for sale, excluding already bought items.
     *
     * @return self
     */
