 ...
 */
class ProductImageProposal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductImageProposal';
     ...
     * Sets current
     *
     * @param string|null $current Current product image url.
     *
     * @return self
     */
     ...
     * Sets proposal
     *
     * @param string|null $proposal Proposed product image url.
     *
     * @return self
     */
