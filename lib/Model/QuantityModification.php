 ...
 */
class QuantityModification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['change_type'] = $data['change_type'] ?? null;
     ...
     * Sets value
     *
     * @param int|null $value - For changeType = \"FIXED\", a new stock quantity > 0 - For changeType = \"GAIN\", an increase/decrease in stock quantity
     *
     * @return self
     */
