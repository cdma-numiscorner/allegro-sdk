 ...
 */
class SellerRebatesDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SellerRebatesDto';
    ...
    protected static $openAPITypes = [
        'promotions' => '\OpenAPI\AllegroSdk\Model\SellerRebateDto[]',
        'total_count' => 'int'
    ];
     ...
     * Gets promotions
     *
     * @return \OpenAPI\AllegroSdk\Model\SellerRebateDto[]
     */
     ...
     * Sets promotions
     *
     * @param \OpenAPI\AllegroSdk\Model\SellerRebateDto[] $promotions promotions
     *
     * @return self
     */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling SellerRebatesDto., must be bigger than or equal to 0.');
        }
