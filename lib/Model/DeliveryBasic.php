...
/**
 * DeliveryBasic Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\AllegroSdk
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryBasic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryBasic';
    ...
    public function setAdditionalInfo($additional_info)
    {
        if (!is_null($additional_info) && (mb_strlen($additional_info) > 650)) {
            throw new \InvalidArgumentException('invalid length for $additional_info when calling DeliveryBasic., must be smaller than or equal to 650.');
        }
