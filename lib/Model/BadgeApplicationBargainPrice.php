 ...
 */
class BadgeApplicationBargainPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BadgeApplicationBargainPrice';
