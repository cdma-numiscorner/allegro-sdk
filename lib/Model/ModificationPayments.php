 ...
 */
class ModificationPayments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModificationPayments';
    ...
    protected static $openAPITypes = [
        'invoice' => 'string',
        'tax' => '\OpenAPI\AllegroSdk\Model\Tax'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invoice']) && !in_array($this->container['invoice'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'invoice', must be one of '%s'",
                $this->container['invoice'],
     ...
     * Sets invoice
     *
     * @param string|null $invoice Invoice type: VAT, VAT_MARGIN, WITHOUT_VAT, NO_INVOICE
     *
     * @return self
     */
     ...
     * Gets tax
     *
     * @return \OpenAPI\AllegroSdk\Model\Tax|null
     */
     ...
     * Sets tax
     *
     * @param \OpenAPI\AllegroSdk\Model\Tax|null $tax tax
     *
     * @return self
     */
