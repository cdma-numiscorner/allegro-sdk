...
/**
 * DisputeAttachment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\AllegroSdk
 * @author   OpenAPI Generator team
 ...
 */
class DisputeAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisputeAttachment';
    ...
    public function setFileName($file_name)
    {
        if ((mb_strlen($file_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling DisputeAttachment., must be smaller than or equal to 255.');
        }
     ...
     * Sets url
     *
     * @param string $url Direct link to the attachment
     *
     * @return self
     */
