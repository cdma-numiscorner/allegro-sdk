...
class Coordinates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setLat($lat)
    {
        ...
        if (($lat > 90)) {
            throw new \InvalidArgumentException('invalid value for $lat when calling Coordinates., must be smaller than or equal to 90.');
        }
        if (($lat < -90)) {
            throw new \InvalidArgumentException('invalid value for $lat when calling Coordinates., must be bigger than or equal to -90.');
        }
    ...
    public function setLon($lon)
    {
        ...
        if (($lon > 180)) {
            throw new \InvalidArgumentException('invalid value for $lon when calling Coordinates., must be smaller than or equal to 180.');
        }
        if (($lon < -180)) {
            throw new \InvalidArgumentException('invalid value for $lon when calling Coordinates., must be bigger than or equal to -180.');
        }
