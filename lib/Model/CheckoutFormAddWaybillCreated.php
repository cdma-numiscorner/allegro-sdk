...
class CheckoutFormAddWaybillCreated implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets waybill
     *
     * @param string|null $waybill Waybill number (parcel tracking number). Cannot be empty and must be no longer than 64 characters. It can contain any word character (equal to [a-zA-Z0-9_]) and special characters: parentheses and hyphen-minus.
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param object[]|null $line_items List of order line items. They must be from the order specified in the path parameter. List cannot be empty.
     *
     * @return self
     */
