 ...
 */
class OfferEventExternalOfferWithPublication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferEventExternalOfferWithPublication';
