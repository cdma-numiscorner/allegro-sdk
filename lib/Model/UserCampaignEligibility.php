 ...
 */
class UserCampaignEligibility implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'eligible' => 'bool',
        'refusal_reasons' => '\OpenAPI\AllegroSdk\Model\CampaignRefusalReason[]'
    ];
    ...
    {
        $this->container['eligible'] = $data['eligible'] ?? null;
     ...
     *
     * @return \OpenAPI\AllegroSdk\Model\CampaignRefusalReason[]
     */
     ...
     *
     * @param \OpenAPI\AllegroSdk\Model\CampaignRefusalReason[] $refusal_reasons Information why user is not able to participate in the campaign.
     *
     * @return self
     */
