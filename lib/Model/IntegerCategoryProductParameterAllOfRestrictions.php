...
/**
 * IntegerCategoryProductParameterAllOfRestrictions Class Doc Comment
 *
 * @category Class
 ...
 */
class IntegerCategoryProductParameterAllOfRestrictions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegerCategoryProductParameter_allOf_restrictions';
     ...
     * Sets min
     *
     * @param int|null $min The minimum value of this parameter.
     *
     * @return self
     */
    public function setMin($min)
    {
        ...
        if (!is_null($min) && ($min < 0)) {
            throw new \InvalidArgumentException('invalid value for $min when calling IntegerCategoryProductParameterAllOfRestrictions., must be bigger than or equal to 0.');
        }
     ...
     * Sets max
     *
     * @param int|null $max The maximum value of this parameter.
     *
     * @return self
     */
    public function setMax($max)
    {
        ...
        if (!is_null($max) && ($max < 1)) {
            throw new \InvalidArgumentException('invalid value for $max when calling IntegerCategoryProductParameterAllOfRestrictions., must be bigger than or equal to 1.');
        }
