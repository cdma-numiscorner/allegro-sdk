...
/**
 * CourierBySellerShippingAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\AllegroSdk
 * @author   OpenAPI Generator team
 ...
 */
class CourierBySellerShippingAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CourierBySellerShipping_allOf';
    ...
    {
        $this->container['method'] = $data['method'] ?? 'COURIER_BY_SELLER';
