...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'state' => 'string',
        'country_code' => 'string',
        'coordinates' => '\OpenAPI\AllegroSdk\Model\Coordinates'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['street']) && (mb_strlen($this->container['street']) > 80)) {
            $invalidProperties[] = "invalid value for 'street', the character length must be smaller than or equal to 80.";
        }
        ...
        if ((mb_strlen($this->container['state']) > 40)) {
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 80)) {
            throw new \InvalidArgumentException('invalid length for $street when calling Address., must be smaller than or equal to 80.');
        }
    ...
    {
        if ((mb_strlen($state) > 40)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Address., must be smaller than or equal to 40.');
        }
     ...
     * Gets coordinates
     *
     * @return \OpenAPI\AllegroSdk\Model\Coordinates|null
     */
     ...
     * Sets coordinates
     *
     * @param \OpenAPI\AllegroSdk\Model\Coordinates|null $coordinates coordinates
     *
     * @return self
     */
