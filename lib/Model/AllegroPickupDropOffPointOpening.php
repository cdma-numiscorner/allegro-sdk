 ...
 */
class AllegroPickupDropOffPointOpening implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AllegroPickupDropOffPoint_opening';
