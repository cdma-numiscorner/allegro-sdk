 ...
 */
class SmartOfferClassificationReportConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartOfferClassificationReport_conditions';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'fulfilled' => 'bool',
        'passed_delivery_methods' => '\OpenAPI\AllegroSdk\Model\DeliveryMethodId[]',
        'failed_delivery_methods' => '\OpenAPI\AllegroSdk\Model\DeliveryMethodId[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['passed_delivery_methods'] = $data['passed_delivery_methods'] ?? null;
        $this->container['failed_delivery_methods'] = $data['failed_delivery_methods'] ?? null;
    }
     ...
     *
     * @return \OpenAPI\AllegroSdk\Model\DeliveryMethodId[]|null
     */
     ...
     *
     * @param \OpenAPI\AllegroSdk\Model\DeliveryMethodId[]|null $passed_delivery_methods Set of delivery methods that meet this condition. May be null if the condition does not apply to delivery methods.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\AllegroSdk\Model\DeliveryMethodId[]|null $failed_delivery_methods Set of delivery methods that fail to meet this condition. May be null if the condition does not apply to delivery methods.
     *
     * @return self
     */
