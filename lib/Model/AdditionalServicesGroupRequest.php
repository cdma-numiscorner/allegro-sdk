 ...
 */
class AdditionalServicesGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdditionalServicesGroupRequest';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'language' => 'string',
        'additional_services' => '\OpenAPI\AllegroSdk\Model\AdditionalServiceRequest[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['additional_services'] === null) {
            $invalidProperties[] = "'additional_services' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name Name of the group provided by merchant, invisible for buyers.
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AdditionalServicesGroupRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AdditionalServicesGroupRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\AllegroSdk\Model\AdditionalServiceRequest[]
     */
     ...
     *
     * @param \OpenAPI\AllegroSdk\Model\AdditionalServiceRequest[] $additional_services additional_services
     *
     * @return self
     */
