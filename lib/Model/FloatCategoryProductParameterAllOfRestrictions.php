...
class FloatCategoryProductParameterAllOfRestrictions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setMin($min)
    {
        ...
        if (!is_null($min) && ($min < 0)) {
            throw new \InvalidArgumentException('invalid value for $min when calling FloatCategoryProductParameterAllOfRestrictions., must be bigger than or equal to 0.');
        }
    ...
    public function setMax($max)
    {
        ...
        if (!is_null($max) && ($max < 0)) {
            throw new \InvalidArgumentException('invalid value for $max when calling FloatCategoryProductParameterAllOfRestrictions., must be bigger than or equal to 0.');
        }
