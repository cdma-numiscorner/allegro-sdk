...
/**
 * ProductCategoryProposal Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductCategoryProposal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductCategoryProposal';
     ...
     * Sets current
     *
     * @param string|null $current Current product category identifier.
     *
     * @return self
     */
     ...
     * Sets proposal
     *
     * @param string|null $proposal Proposed product category identifier.
     *
     * @return self
     */
