...
/**
 * MultiPackBenefitSpecificationAllOfConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class MultiPackBenefitSpecificationAllOfConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiPackBenefitSpecification_allOf_configuration';
    ...
    public function setPercentage($percentage)
    {
        ...
        if (($percentage < 1)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling MultiPackBenefitSpecificationAllOfConfiguration., must be bigger than or equal to 1.');
        }
