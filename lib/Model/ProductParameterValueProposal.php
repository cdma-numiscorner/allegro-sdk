...
/**
 * ProductParameterValueProposal Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductParameterValueProposal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductParameterValueProposal';
     ...
     * Sets current
     *
     * @param string|null $current Current product parameter value.
     *
     * @return self
     */
     ...
     * Sets proposal
     *
     * @param string|null $proposal Proposed product parameter value.
     *
     * @return self
     */
