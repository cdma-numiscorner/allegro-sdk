 ...
 *
 * @category Class
 * @description Represents information about package shipment. Constraints:   * for method COURIER_BY_SELLER: trackingNumber is required,   * for method OWN_TRANSPORT: truckLicencePlate and estimatedTimeOfArrival are required.
 * @package  OpenAPI\AllegroSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Shipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets method
     *
     * @param string $method The method to deliver the Advance Ship Notice.
     *
     * @return self
     */
