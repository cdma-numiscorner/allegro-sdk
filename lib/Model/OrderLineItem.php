...
class OrderLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderLineItem., must be bigger than or equal to 0.');
        }
     ...
     * Sets original_price
     *
     * @param \OpenAPI\AllegroSdk\Model\Price|null $original_price original_price
     *
     * @return self
     */
