...
class CharityApi
{
     ...
     * @return \OpenAPI\AllegroSdk\Model\FundraisingCampaigns
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\FundraisingCampaigns, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchFundraisingCampaignsWithHttpInfo($limit, $phrase)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\FundraisingCampaigns' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\FundraisingCampaigns', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\FundraisingCampaigns';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\FundraisingCampaigns',
