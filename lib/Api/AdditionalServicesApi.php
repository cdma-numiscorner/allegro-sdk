...
class AdditionalServicesApi
{
     ...
     *
     * @param  \OpenAPI\AllegroSdk\Model\AdditionalServicesGroupRequest $additional_services_group_request Additional service group body (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdditionalServicesGroupResponse
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdditionalServicesGroupResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdditionalServicesGroupUsingPOSTWithHttpInfo($additional_services_group_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\AllegroSdk\Model\AdditionalServicesGroupResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\AdditionalServicesGroupResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\AdditionalServicesGroupResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\AdditionalServicesGroupResponse',
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\DefinitionsResponse
     */
    public function getListOfAdditionalServicesDefinitionsUsingGET($offset = 0, $limit = 100)
    {
        list($response) = $this->getListOfAdditionalServicesDefinitionsUsingGETWithHttpInfo($offset, $limit);
        return $response;
    }
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\DefinitionsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListOfAdditionalServicesDefinitionsUsingGETWithHttpInfo($offset = 0, $limit = 100)
    {
        $request = $this->getListOfAdditionalServicesDefinitionsUsingGETRequest($offset, $limit);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\DefinitionsResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\DefinitionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\DefinitionsResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\DefinitionsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListOfAdditionalServicesDefinitionsUsingGETAsync($offset = 0, $limit = 100)
    {
        return $this->getListOfAdditionalServicesDefinitionsUsingGETAsyncWithHttpInfo($offset, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListOfAdditionalServicesDefinitionsUsingGETAsyncWithHttpInfo($offset = 0, $limit = 100)
    {
        $returnType = '\OpenAPI\AllegroSdk\Model\DefinitionsResponse';
        $request = $this->getListOfAdditionalServicesDefinitionsUsingGETRequest($offset, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getListOfAdditionalServicesDefinitionsUsingGETRequest($offset = 0, $limit = 100)
    {
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdditionalServicesGroups
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdditionalServicesGroups, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListOfAdditionalServicesGroupsUsingGETWithHttpInfo($offset = 0, $limit = 100)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\AdditionalServicesGroups' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\AdditionalServicesGroups', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\AdditionalServicesGroups';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\AdditionalServicesGroups',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
