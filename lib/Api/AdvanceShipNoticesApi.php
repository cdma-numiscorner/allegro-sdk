...
class AdvanceShipNoticesApi
{
     ...
     *
     * @param  \OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeRequest $create_advance_ship_notice_request create_advance_ship_notice_request (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     * Create an Advance Ship Notice
     *
     * @param  \OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeRequest $create_advance_ship_notice_request (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvanceShipNoticeWithHttpInfo($create_advance_ship_notice_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeResponse', []),
            ...
            $returnType = '\OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\CreateAdvanceShipNoticeResponse',
     ...
     * @param  \OpenAPI\AllegroSdk\Model\CreateLabelsCommandOnlyInput $create_labels_command_only_input create_labels_command_only_input (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\CreateLabelsCommand|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     *
     * @param  string $command_id The identifier of the command. (required)
     * @param  \OpenAPI\AllegroSdk\Model\CreateLabelsCommandOnlyInput $create_labels_command_only_input (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\CreateLabelsCommand|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLabelsCommandWithHttpInfo($command_id, $create_labels_command_only_input)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\AllegroSdk\Model\CreateLabelsCommand' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\CreateLabelsCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\AllegroSdk\Model\CreateLabelsCommand';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\CreateLabelsCommand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvanceShipNoticeWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\ReceivingState
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\ReceivingState, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvanceShipNoticeReceivingStateWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\ReceivingState' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\ReceivingState', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\ReceivingState';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\ReceivingState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeStatus[] $status A status of the Advance Ship Notices in the response. (optional)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeList|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeList|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvanceShipNoticesWithHttpInfo($offset = 0, $limit = 50, $status = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeList';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\AdvanceShipNoticeList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\SubmitCommand|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\SubmitCommand|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubmitCommandWithHttpInfo($command_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\SubmitCommand' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\SubmitCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\OpenAPI\AllegroSdk\Model\SubmitCommand';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\SubmitCommand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $command_id The identifier of the command. (required)
     * @param  \OpenAPI\AllegroSdk\Model\SubmitCommand $submit_command submit_command (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\SubmitCommand|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     ...
     *
     * @param  string $command_id The identifier of the command. (required)
     * @param  \OpenAPI\AllegroSdk\Model\SubmitCommand $submit_command (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\SubmitCommand|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \OpenAPI\AllegroSdk\Model\AdvanceShipNotice $advance_ship_notice advance_ship_notice (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     * @param  string $id An identifier of Advance Ship Notice. (required)
     * @param  string $if_match A current version of Advance Ship Notice (e.g. from etag header obtained via get). (required)
     * @param  \OpenAPI\AllegroSdk\Model\AdvanceShipNotice $advance_ship_notice (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdvanceShipNoticeResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
