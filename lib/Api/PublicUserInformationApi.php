...
class PublicUserInformationApi
{
     ...
     * @return \OpenAPI\AllegroSdk\Model\UserRatingSummaryResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\UserRatingSummaryResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserSummaryUsingGETWithHttpInfo($user_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\UserRatingSummaryResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\UserRatingSummaryResponse', []),
            ...
            $returnType = '\OpenAPI\AllegroSdk\Model\UserRatingSummaryResponse';
            $responseBody = $response->getBody();
     ...
     */
    public function getUserSummaryUsingGETRequest($user_id)
    {
