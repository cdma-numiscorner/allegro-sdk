...
class BatchOfferModificationApi
{
     ...
     *
     * @param  string $command_id Command identifier. (required)
     * @param  \OpenAPI\AllegroSdk\Model\OfferChangeCommand $offer_change_command offerChangeCommandDto (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\GeneralReport
     ...
     *
     * @param  string $command_id Command identifier. (required)
     * @param  \OpenAPI\AllegroSdk\Model\OfferPriceChangeCommand $offer_price_change_command offerPriceChangeCommandDto (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\GeneralReport
     ...
     *
     * @param  string $command_id Command identifier. (required)
     * @param  \OpenAPI\AllegroSdk\Model\OfferQuantityChangeCommand $offer_quantity_change_command offerQuantityChangeCommandDto (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\GeneralReport
