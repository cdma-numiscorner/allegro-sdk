...
class CommissionRefundsApi
{
     ...
     *
     * @param  \OpenAPI\AllegroSdk\Model\RefundClaimRequest $refund_claim_request refund_claim_request (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\RefundClaimResponse
     */
    public function createRefundApplication($refund_claim_request)
    {
        list($response) = $this->createRefundApplicationWithHttpInfo($refund_claim_request);
        return $response;
    }
     ...
     * Create a refund application
     *
     * @param  \OpenAPI\AllegroSdk\Model\RefundClaimRequest $refund_claim_request (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\RefundClaimResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRefundApplicationWithHttpInfo($refund_claim_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\AllegroSdk\Model\RefundClaimResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\RefundClaimResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\RefundClaimResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\RefundClaimResponse',
    ...
    public function createRefundApplicationRequest($refund_claim_request)
    {
        ...
        if (isset($refund_claim_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($refund_claim_request));
            } else {
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\RefundClaim
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\RefundClaim, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRefundApplicationWithHttpInfo($claim_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\RefundClaim' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\RefundClaim', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\RefundClaim';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\RefundClaim',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
