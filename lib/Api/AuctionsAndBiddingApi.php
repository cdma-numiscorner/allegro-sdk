...
class AuctionsAndBiddingApi
{
     ...
     * @return \OpenAPI\AllegroSdk\Model\MyBidResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\MyBidResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBidWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\MyBidResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\MyBidResponse', []),
            ...
            $returnType = '\OpenAPI\AllegroSdk\Model\MyBidResponse';
            $responseBody = $response->getBody();
     ...
     *
     * @param  string $offer_id The offer ID. (required)
     * @param  \OpenAPI\AllegroSdk\Model\BidRequest $bid_request bid_request (optional)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\MyBidResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\AuthError|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\ErrorsHolder
     */
    public function placeBid($offer_id, $bid_request = null)
    {
        list($response) = $this->placeBidWithHttpInfo($offer_id, $bid_request);
        return $response;
    }
     ...
     *
     * @param  string $offer_id The offer ID. (required)
     * @param  \OpenAPI\AllegroSdk\Model\BidRequest $bid_request (optional)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\MyBidResponse|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\AuthError|\OpenAPI\AllegroSdk\Model\ErrorsHolder|\OpenAPI\AllegroSdk\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function placeBidRequest($offer_id, $bid_request = null)
    {
        ...
        if (isset($bid_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($bid_request));
            } else {
