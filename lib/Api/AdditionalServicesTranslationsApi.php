...
class AdditionalServicesTranslationsApi
{
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationResponse
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdditionalServiceGroupTranslationsWithHttpInfo($group_id, $language = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationResponse',
     ...
     * @param  string $group_id Additional Service Group ID. (required)
     * @param  string $language IETF Language tag. (required)
     * @param  \OpenAPI\AllegroSdk\Model\AdditionalServicesGroupTranslationRequest $additional_services_group_translation_request Additonal service group translation. (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationPatchResponse
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationPatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateAdditionalServiceGroupTranslationWithHttpInfo($group_id, $language, $additional_services_group_translation_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationPatchResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationPatchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationPatchResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\AdditionalServiceGroupTranslationPatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
