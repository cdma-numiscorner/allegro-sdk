...
class OfferVariantsApi
{
     ...
     * Create variant set
     *
     * @param  \OpenAPI\AllegroSdk\Model\VariantSet $variant_set variant_set (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\VariantSetResponse
     */
     ...
     * Create variant set
     *
     * @param  \OpenAPI\AllegroSdk\Model\VariantSet $variant_set (required)
     *
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\VariantSetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createVariantSetWithHttpInfo($variant_set)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\AllegroSdk\Model\VariantSetResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\VariantSetResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\VariantSetResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\VariantSetResponse',
    ...
    public function createVariantSetRequest($variant_set)
    {
        ...
        if (isset($variant_set)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($variant_set));
            } else {
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\AllegroSdk\Model\VariantSets
     */
     ...
     * @throws \OpenAPI\AllegroSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\AllegroSdk\Model\VariantSets, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariantSetsWithHttpInfo($offset = 0, $limit = 10, $query = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\AllegroSdk\Model\VariantSets' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\AllegroSdk\Model\VariantSets', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\AllegroSdk\Model\VariantSets';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\AllegroSdk\Model\VariantSets',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
