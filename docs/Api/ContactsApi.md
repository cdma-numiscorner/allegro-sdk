# OpenAPI\AllegroSdk\ContactsApi
...
```php
createContactUsingPOST($contact_request): \OpenAPI\AllegroSdk\Model\ContactResponse
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\ContactsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$contact_request = new \OpenAPI\AllegroSdk\Model\ContactRequest(); // \OpenAPI\AllegroSdk\Model\ContactRequest | New contact
...
------------- | ------------- | ------------- | -------------
 **contact_request** | [**\OpenAPI\AllegroSdk\Model\ContactRequest**](../Model/ContactRequest.md)| New contact |

### Return type

[**\OpenAPI\AllegroSdk\Model\ContactResponse**](../Model/ContactResponse.md)
...
```php
getContactUsingGET($id): \OpenAPI\AllegroSdk\Model\ContactResponse
```
...
```php
getListOfContactsUsingGET(): \OpenAPI\AllegroSdk\Model\ContactResponseList
```
...
[**\OpenAPI\AllegroSdk\Model\ContactResponseList**](../Model/ContactResponseList.md)
...
```php
modifyContactUsingPUT($id, $contact_request): \OpenAPI\AllegroSdk\Model\ContactResponse
```
...
$id = 'id_example'; // string | Contact identifier.
$contact_request = new \OpenAPI\AllegroSdk\Model\ContactRequest(); // \OpenAPI\AllegroSdk\Model\ContactRequest | Contact
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Contact identifier. |
 **contact_request** | [**\OpenAPI\AllegroSdk\Model\ContactRequest**](../Model/ContactRequest.md)| Contact |
