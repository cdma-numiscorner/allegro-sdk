# OpenAPI\AllegroSdk\OfferManagementApi
...
```php
changePublicationStatusUsingPUT($command_id, $publication_change_command_dto): \OpenAPI\AllegroSdk\Model\GeneralReport
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\OfferManagementApi(
...
$publication_change_command_dto = new \OpenAPI\AllegroSdk\Model\PublicationChangeCommandDto(); // \OpenAPI\AllegroSdk\Model\PublicationChangeCommandDto | publicationChangeCommandDto
 ...
 **publication_change_command_dto** | [**\OpenAPI\AllegroSdk\Model\PublicationChangeCommandDto**](../Model/PublicationChangeCommandDto.md)| publicationChangeCommandDto |
...
```php
createChangePriceCommandUsingPUT($offer_id, $command_id, $change_price_without_output): \OpenAPI\AllegroSdk\Model\ChangePrice
```
...
$change_price_without_output = new \OpenAPI\AllegroSdk\Model\ChangePriceWithoutOutput(); // \OpenAPI\AllegroSdk\Model\ChangePriceWithoutOutput
 ...
 **change_price_without_output** | [**\OpenAPI\AllegroSdk\Model\ChangePriceWithoutOutput**](../Model/ChangePriceWithoutOutput.md)|  |

### Return type

[**\OpenAPI\AllegroSdk\Model\ChangePrice**](../Model/ChangePrice.md)
...
```php
createOfferUsingPOST($unknown_base_type): \OpenAPI\AllegroSdk\Model\OfferResponse
```
...
$unknown_base_type = new \OpenAPI\AllegroSdk\Model\UNKNOWN_BASE_TYPE(); // \OpenAPI\AllegroSdk\Model\UNKNOWN_BASE_TYPE | offer
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **unknown_base_type** | [**\OpenAPI\AllegroSdk\Model\UNKNOWN_BASE_TYPE**](../Model/UNKNOWN_BASE_TYPE.md)| offer |
...
```php
createProductOffers($sale_product_offer_request_v1): \OpenAPI\AllegroSdk\Model\SaleProductOfferResponseV1
```
...
$sale_product_offer_request_v1 = new \OpenAPI\AllegroSdk\Model\SaleProductOfferRequestV1(); // \OpenAPI\AllegroSdk\Model\SaleProductOfferRequestV1
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sale_product_offer_request_v1** | [**\OpenAPI\AllegroSdk\Model\SaleProductOfferRequestV1**](../Model/SaleProductOfferRequestV1.md)|  |

### Return type

[**\OpenAPI\AllegroSdk\Model\SaleProductOfferResponseV1**](../Model/SaleProductOfferResponseV1.md)
...
```php
editProductOffers($offer_id, $sale_product_offer_patch_request_v1): \OpenAPI\AllegroSdk\Model\SaleProductOfferResponseV1
```
...
$offer_id = 'offer_id_example'; // string | The offer identifier.
$sale_product_offer_patch_request_v1 = new \OpenAPI\AllegroSdk\Model\SaleProductOfferPatchRequestV1(); // \OpenAPI\AllegroSdk\Model\SaleProductOfferPatchRequestV1
...
------------- | ------------- | ------------- | -------------
 **offer_id** | **string**| The offer identifier. |
 **sale_product_offer_patch_request_v1** | [**\OpenAPI\AllegroSdk\Model\SaleProductOfferPatchRequestV1**](../Model/SaleProductOfferPatchRequestV1.md)|  |
...
```php
getAvailableOfferPromotionPackages(): \OpenAPI\AllegroSdk\Model\AvailablePromotionPackages
```
...
[**\OpenAPI\AllegroSdk\Model\AvailablePromotionPackages**](../Model/AvailablePromotionPackages.md)
...
```php
getOfferPromoOptionsUsingGET($offer_id): \OpenAPI\AllegroSdk\Model\OfferPromoOptions
```
...
[**\OpenAPI\AllegroSdk\Model\OfferPromoOptions**](../Model/OfferPromoOptions.md)
...
```php
getOffersUnfilledParametersUsingGET1($offer_id, $parameter_type, $offset, $limit): \OpenAPI\AllegroSdk\Model\UnfilledParametersResponse
```
...
[**\OpenAPI\AllegroSdk\Model\UnfilledParametersResponse**](../Model/UnfilledParametersResponse.md)
...
```php
getProductOffer($offer_id): \OpenAPI\AllegroSdk\Model\SaleProductOfferResponseV1
```
...
```php
getProductOfferProcessingStatus($offer_id, $operation_id): \OpenAPI\AllegroSdk\Model\SaleProductOfferStatusResponse
```
...
[**\OpenAPI\AllegroSdk\Model\SaleProductOfferStatusResponse**](../Model/SaleProductOfferStatusResponse.md)
...
```php
getPromoModificationCommandDetailedResultUsingGET($command_id, $limit, $offset): \OpenAPI\AllegroSdk\Model\PromoModificationReport
```
...
[**\OpenAPI\AllegroSdk\Model\PromoModificationReport**](../Model/PromoModificationReport.md)
...
```php
getPromoModificationCommandResultUsingGET($command_id): \OpenAPI\AllegroSdk\Model\GeneralReport
```
...
```php
getPromoOptionsForSellerOffersUsingGET($limit, $offset): \OpenAPI\AllegroSdk\Model\OfferPromoOptionsForSeller
```
...
[**\OpenAPI\AllegroSdk\Model\OfferPromoOptionsForSeller**](../Model/OfferPromoOptionsForSeller.md)
...
```php
getPublicationReportUsingGET($command_id): \OpenAPI\AllegroSdk\Model\GeneralReport
```
...
```php
getPublicationTasksUsingGET($command_id, $limit, $offset): \OpenAPI\AllegroSdk\Model\TaskReport
```
...
```php
modifyOfferPromoOptionsUsingPOST($offer_id, $promo_options_modifications): \OpenAPI\AllegroSdk\Model\OfferPromoOptions
```
...
$offer_id = 9991337999; // string | Offer identifier.
$promo_options_modifications = new \OpenAPI\AllegroSdk\Model\PromoOptionsModifications(); // \OpenAPI\AllegroSdk\Model\PromoOptionsModifications | request
...
------------- | ------------- | ------------- | -------------
 **offer_id** | **string**| Offer identifier. |
 **promo_options_modifications** | [**\OpenAPI\AllegroSdk\Model\PromoOptionsModifications**](../Model/PromoOptionsModifications.md)| request |
...
```php
promoModificationCommandUsingPUT($command_id, $promo_options_command): \OpenAPI\AllegroSdk\Model\GeneralReport
```
...
$promo_options_command = new \OpenAPI\AllegroSdk\Model\PromoOptionsCommand(); // \OpenAPI\AllegroSdk\Model\PromoOptionsCommand | Promo packages modification command request.
 ...
 **promo_options_command** | [**\OpenAPI\AllegroSdk\Model\PromoOptionsCommand**](../Model/PromoOptionsCommand.md)| Promo packages modification command request. |
...
```php
updateOfferUsingPUT($offer_id, $unknown_base_type): \OpenAPI\AllegroSdk\Model\OfferResponse
```
