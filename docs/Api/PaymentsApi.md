# OpenAPI\AllegroSdk\PaymentsApi
...
```php
getPaymentsOperationHistory($wallet_type, $wallet_payment_operator, $payment_id, $participant_login, $occurred_at_gte, $occurred_at_lte, $group, $marketplace_id, $currency, $limit, $offset): \OpenAPI\AllegroSdk\Model\PaymentOperations
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\PaymentsApi(
...
[**\OpenAPI\AllegroSdk\Model\PaymentOperations**](../Model/PaymentOperations.md)
...
```php
initiateRefund($initialize_refund): \OpenAPI\AllegroSdk\Model\RefundDetails
```
...
$initialize_refund = new \OpenAPI\AllegroSdk\Model\InitializeRefund(); // \OpenAPI\AllegroSdk\Model\InitializeRefund
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **initialize_refund** | [**\OpenAPI\AllegroSdk\Model\InitializeRefund**](../Model/InitializeRefund.md)|  | [optional]

### Return type

[**\OpenAPI\AllegroSdk\Model\RefundDetails**](../Model/RefundDetails.md)
