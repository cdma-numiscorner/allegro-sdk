...
```php
searchFundraisingCampaigns($limit, $phrase): \OpenAPI\AllegroSdk\Model\FundraisingCampaigns
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\CharityApi(
...
[**\OpenAPI\AllegroSdk\Model\FundraisingCampaigns**](../Model/FundraisingCampaigns.md)
