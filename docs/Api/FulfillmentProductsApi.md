# OpenAPI\AllegroSdk\FulfillmentProductsApi
...
```php
getAvailableProducts($offset, $limit): \OpenAPI\AllegroSdk\Model\AvailableProductsList
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\FulfillmentProductsApi(
...
[**\OpenAPI\AllegroSdk\Model\AvailableProductsList**](../Model/AvailableProductsList.md)
