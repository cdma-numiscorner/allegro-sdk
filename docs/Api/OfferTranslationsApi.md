# OpenAPI\AllegroSdk\OfferTranslationsApi
...
$apiInstance = new OpenAPI\AllegroSdk\Api\OfferTranslationsApi(
...
```php
getOfferTranslationUsingGET($offer_id, $language): \OpenAPI\AllegroSdk\Model\OfferTranslations
```
...
[**\OpenAPI\AllegroSdk\Model\OfferTranslations**](../Model/OfferTranslations.md)
...
$offer_id = 'offer_id_example'; // string | Offer identifier.
$manual_translation_update_request = new \OpenAPI\AllegroSdk\Model\ManualTranslationUpdateRequest(); // \OpenAPI\AllegroSdk\Model\ManualTranslationUpdateRequest | Request with manual translation for offer, must contain at least one translated offer element (title or description).
 ...
 **offer_id** | **string**| Offer identifier. |
 **manual_translation_update_request** | [**\OpenAPI\AllegroSdk\Model\ManualTranslationUpdateRequest**](../Model/ManualTranslationUpdateRequest.md)| Request with manual translation for offer, must contain at least one translated offer element (title or description). |
