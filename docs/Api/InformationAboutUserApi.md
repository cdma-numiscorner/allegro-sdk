# OpenAPI\AllegroSdk\InformationAboutUserApi
...
```php
addAdditionalEmailUsingPOST($additional_email_request): \OpenAPI\AllegroSdk\Model\AdditionalEmail
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\InformationAboutUserApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$additional_email_request = new \OpenAPI\AllegroSdk\Model\AdditionalEmailRequest(); // \OpenAPI\AllegroSdk\Model\AdditionalEmailRequest | request
...
------------- | ------------- | ------------- | -------------
 **additional_email_request** | [**\OpenAPI\AllegroSdk\Model\AdditionalEmailRequest**](../Model/AdditionalEmailRequest.md)| request |

### Return type

[**\OpenAPI\AllegroSdk\Model\AdditionalEmail**](../Model/AdditionalEmail.md)
...
```php
answerUserRatingUsingPUT($rating_id, $user_rating_answer_request): \OpenAPI\AllegroSdk\Model\Answer
```
...
$user_rating_answer_request = new \OpenAPI\AllegroSdk\Model\UserRatingAnswerRequest(); // \OpenAPI\AllegroSdk\Model\UserRatingAnswerRequest | User rating answer request.
 ...
 **user_rating_answer_request** | [**\OpenAPI\AllegroSdk\Model\UserRatingAnswerRequest**](../Model/UserRatingAnswerRequest.md)| User rating answer request. |

### Return type

[**\OpenAPI\AllegroSdk\Model\Answer**](../Model/Answer.md)
...
```php
getAdditionalEmailUsingGET($email_id): \OpenAPI\AllegroSdk\Model\AdditionalEmail
```
...
```php
getListOfAdditionalEmailsUsingGET(): \OpenAPI\AllegroSdk\Model\AdditionalEmailsResponse
```
...
[**\OpenAPI\AllegroSdk\Model\AdditionalEmailsResponse**](../Model/AdditionalEmailsResponse.md)
...
```php
getSellerSmartClassificationGET(): \OpenAPI\AllegroSdk\Model\SmartSellerClassificationReport
```
...
[**\OpenAPI\AllegroSdk\Model\SmartSellerClassificationReport**](../Model/SmartSellerClassificationReport.md)
...
```php
getUserRatingsUsingGET($recommended, $last_changed_at_gte, $last_changed_at_lte, $offset, $limit): \OpenAPI\AllegroSdk\Model\UserRatingListResponse
```
...
[**\OpenAPI\AllegroSdk\Model\UserRatingListResponse**](../Model/UserRatingListResponse.md)
...
```php
meGET(): \OpenAPI\AllegroSdk\Model\MeResponse
```
...
[**\OpenAPI\AllegroSdk\Model\MeResponse**](../Model/MeResponse.md)
...
```php
userRatingRemovalUsingPUT($rating_id, $user_rating_removal_request): \OpenAPI\AllegroSdk\Model\Removal
```
...
$rating_id = 5df0a6d1ef437e00255572a1; // string | ID of the rating.
$user_rating_removal_request = new \OpenAPI\AllegroSdk\Model\UserRatingRemovalRequest(); // \OpenAPI\AllegroSdk\Model\UserRatingRemovalRequest | User rating removal request.
...
------------- | ------------- | ------------- | -------------
 **rating_id** | **string**| ID of the rating. |
 **user_rating_removal_request** | [**\OpenAPI\AllegroSdk\Model\UserRatingRemovalRequest**](../Model/UserRatingRemovalRequest.md)| User rating removal request. |

### Return type

[**\OpenAPI\AllegroSdk\Model\Removal**](../Model/Removal.md)
