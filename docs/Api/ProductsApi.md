# OpenAPI\AllegroSdk\ProductsApi
...
[**getProductChanges()**](ProductsApi.md#getProductChanges) | **GET** /sale/product-changes | Get any data the last product changes
...
```php
getFlatProductParametersUsingGET($category_id): \OpenAPI\AllegroSdk\Model\CategoryProductParameterList
```
...
$apiInstance = new OpenAPI\AllegroSdk\Api\ProductsApi(
...
[**\OpenAPI\AllegroSdk\Model\CategoryProductParameterList**](../Model/CategoryProductParameterList.md)
...
```php
getProductChangeProposal($change_proposal_id): \OpenAPI\AllegroSdk\Model\ProductChangeProposalDto
```
...
[**\OpenAPI\AllegroSdk\Model\ProductChangeProposalDto**](../Model/ProductChangeProposalDto.md)
...
$product_id = array('product_id_example'); // string[] | List of product ids.
$from = 'from_example'; // string | Time from when product changes have to be returned in ISO 8601 format. By default one day.
$to = 'to_example'; // string | Time to when product changes have to be returned in ISO 8601 format. By default current time.

try {
    $result = $apiInstance->getProductChanges($product_id, $from, $to);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProductsApi->getProductChanges: ', $e->getMessage(), PHP_EOL;
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **product_id** | [**string[]**](../Model/string.md)| List of product ids. |
 **from** | **string**| Time from when product changes have to be returned in ISO 8601 format. By default one day. | [optional]
 **to** | **string**| Time to when product changes have to be returned in ISO 8601 format. By default current time. | [optional]

### Return type

[**\OpenAPI\AllegroSdk\Model\ProductChangesResponse**](../Model/ProductChangesResponse.md)
...
```php
getSaleProduct($product_id, $category_id, $include_drafts, $language): \OpenAPI\AllegroSdk\Model\SaleProductDto
```
...
[**\OpenAPI\AllegroSdk\Model\SaleProductDto**](../Model/SaleProductDto.md)
...
```php
getSaleProducts($ean, $phrase, $mode, $language, $category_id, $dynamic_filters, $page_id, $search_features, $include_drafts): \OpenAPI\AllegroSdk\Model\GetSaleProductsResponse
```
...
[**\OpenAPI\AllegroSdk\Model\GetSaleProductsResponse**](../Model/GetSaleProductsResponse.md)
...
```php
productChangeProposal($product_id, $product_change_proposal_request): \OpenAPI\AllegroSdk\Model\ProductChangeProposalDto
```
...
$product_id = 'product_id_example'; // string | The product identifier.
$product_change_proposal_request = new \OpenAPI\AllegroSdk\Model\ProductChangeProposalRequest(); // \OpenAPI\AllegroSdk\Model\ProductChangeProposalRequest
...
------------- | ------------- | ------------- | -------------
 **product_id** | **string**| The product identifier. |
 **product_change_proposal_request** | [**\OpenAPI\AllegroSdk\Model\ProductChangeProposalRequest**](../Model/ProductChangeProposalRequest.md)|  |
...
```php
proposeSaleProduct($propose_sale_product_request): \OpenAPI\AllegroSdk\Model\SaleProductDto
```
...
$propose_sale_product_request = new \OpenAPI\AllegroSdk\Model\ProposeSaleProductRequest(); // \OpenAPI\AllegroSdk\Model\ProposeSaleProductRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **propose_sale_product_request** | [**\OpenAPI\AllegroSdk\Model\ProposeSaleProductRequest**](../Model/ProposeSaleProductRequest.md)|  |
