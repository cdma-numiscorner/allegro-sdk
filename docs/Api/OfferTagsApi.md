# OpenAPI\AllegroSdk\OfferTagsApi
...
$apiInstance = new OpenAPI\AllegroSdk\Api\OfferTagsApi(
...
$tag_ids_request = new \OpenAPI\AllegroSdk\Model\TagIdsRequest(); // \OpenAPI\AllegroSdk\Model\TagIdsRequest | request
 ...
 **tag_ids_request** | [**\OpenAPI\AllegroSdk\Model\TagIdsRequest**](../Model/TagIdsRequest.md)| request |
...
```php
createTagPOST1($tag_request): \OpenAPI\AllegroSdk\Model\TagId
```
...
$tag_request = new \OpenAPI\AllegroSdk\Model\TagRequest(); // \OpenAPI\AllegroSdk\Model\TagRequest | request
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tag_request** | [**\OpenAPI\AllegroSdk\Model\TagRequest**](../Model/TagRequest.md)| request |

### Return type

[**\OpenAPI\AllegroSdk\Model\TagId**](../Model/TagId.md)
...
```php
listAssignedOfferTagsGET($offer_id): \OpenAPI\AllegroSdk\Model\TagListResponse
```
...
[**\OpenAPI\AllegroSdk\Model\TagListResponse**](../Model/TagListResponse.md)
...
```php
listSellerTagsGET1($limit, $offset): \OpenAPI\AllegroSdk\Model\TagListResponse
```
...
Use this resource to update a tag. Read more: <a href=\"../../news/nowe-zasoby-zarzadzaj-tagami-i-zalacznikami-w-ofertach-1nzlmKLPyHl\" target=\"_blank\">PL</a> / <a href=\"../../news/new-resources-manage-tags-and-attachments-in-offers-WvGz12BXrHL\" target=\"_blank\">EN</a>. This resource is rate limited to 1 milion offer changes per hour.
